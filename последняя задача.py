...
class AuthApp:
    ...
    def show_congratulations(self, login):
        ...
        congrats_win.title("С новым годом!")
        ...
        if os.path.exists("7.png"):
            ...
            tk.Label(title_frame, text="Января",
                     font=("Arial", 36, "bold"), fg=gold_color, bg=bg_color1).pack()

            tk.Label(title_frame, text="С новым годом",
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    app = AuthApp(root)
>>>>>>> c8bae82f0b6f608adf61ad5d1e4e13951c4f9634
    root.mainloop()